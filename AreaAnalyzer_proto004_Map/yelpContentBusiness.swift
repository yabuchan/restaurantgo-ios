...
class Business: NSObject {
    ...
    init(dictionary: NSDictionary) {
        ...
        if location != nil {
            ...
            if coordinate != nil {
                longtitude = (coordinate!["longitude"] as? Double)!
    ...
    class func searchWithTerm(term: String, lat: Double, lng: Double, sort: YelpSortMode?, categories: [String]?, deals: Bool?, page_index: Int, limit: Int, completion: ([Business]!, NSError!) -> Void) -> Void {
        YelpClient.sharedInstance.searchWithTerm(term, lat: lat, lng: lng, sort: sort, categories: categories, deals: deals, page_index: page_index, limit: limit, completion: completion)
    }
}