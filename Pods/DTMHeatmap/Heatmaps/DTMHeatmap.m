...
//              original
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
//MARK: convert heatmap type from array to NSDictionary
- (NSDictionary *)convertHeatmapDataOfWeight:(NSArray *)heatmapweight
                             heatmapLatitude:(NSArray *)heatmapLatitude
                           heatmapLongtitude:(NSArray *)heatmapLongtitude
                                     dataNum:(int)dataNum
{
    NSMutableDictionary *ret = [NSMutableDictionary new];
    for (int i =0; i < dataNum; i++){
        CLLocationDegrees latitude = [heatmapLatitude[i] doubleValue];
        CLLocationDegrees longitude = [heatmapLongtitude[i] doubleValue];
        double weight = [heatmapweight[i] doubleValue];
